...
NICHES = {
    "Coding Tutorials": {
        ...
        "metadata": {
            "description": "Educational programming content including tutorials, project walkthroughs, and coding tips",
            "content_examples": ["Python for beginners", "LeetCode solutions", "Build a full-stack app"],
            "audience": "Aspiring developers, CS students, career switchers",
            "time_to_monetization": "12-18 months",
            "key_success_factors": ["Consistency", "Project-based learning", "Community engagement"]
        }
    },
    "AI Tools & Tech Explainers": {
        "attributes": {
            "skill": 8,
            "time": 6,
        ...
        "metadata": {
            "description": "Explaining AI tools, tech news, and emerging technologies to general audience",
            "content_examples": ["ChatGPT tutorials", "AI news breakdown", "Tool comparisons"],
            "audience": "Tech-curious professionals, early adopters, general audience",
            "time_to_monetization": "6-12 months",
            "key_success_factors": ["Speed to trending topics", "Clarity of explanation", "Practical demos"]
        }
    },
    "Gaming Content": {
        "attributes": {
        ...
        "metadata": {
            "description": "Gameplay videos, reviews, commentary, and gaming culture content",
            "content_examples": ["Let's Play series", "Game reviews", "Esports commentary"],
